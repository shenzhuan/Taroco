package cn.mallcloud.common.redis.template;
 ...
 */
@Slf4j
public class MallcloudRedisRepository {
    ...
    public MallcloudRedisRepository(RedisTemplate<String, String> redisTemplate) {
